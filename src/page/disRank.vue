        ...
        <yd-list theme="1" slot="list">
          <!--<yd-list-item v-for="item in list">-->
            <div class="a_item" v-for="(item,index) in list">
              ...
              <div class="a_itemimg" :style="{backgroundImage:'url('+comimg+item.coverImgUrl+')'}"></div>
...
<script>
  export default {
    ...
    methods:{
      ...
      loadList(){
        this.$http.post(this.$api.apihost+'project/getRankingPro',{
          ...
          if (_list.length < this.pageSize || this.pagenum == pagecount) {
            /* 所有数据加载完毕 */
