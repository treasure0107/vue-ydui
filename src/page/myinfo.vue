  ...
  <div>
    <yd-layout>
      <yd-cell-group title="" class="clearbottom">
        <yd-cell-item arrow href="/infosOfme" type="link" class="dr_header">
          <div slot="left" class="wl_left">
            ...
            <div>
              ...
              <!-- <p v-if="userinfos.uid==''"><router-link to="login" style="color: #6198D4;">登录</router-link></p> -->
      ...
      <ul class="info_list">
        <li class="info_item icon_c">
          <router-link to="/waitingToVisit" class="info_skip">我的申请
            <i class="num_a"></i>
            <span></span>
          </router-link>
        </li>
        <li class="my_clients icon_c">
          <router-link to="/waitVisitList">我的客户
            <i class="num_a"></i>
            <span></span>
          </router-link>
        </li>
        <li class="my_project icon_c">
          <router-link to="/myProject">我的项目
            <span></span>
          </router-link>
        </li>
      </ul>
      <ul class="info_list">
        <li class="info_photo icon_c">
          <router-link to="/space">相册
            <span></span>
          </router-link>
        </li>
        <li class="info_collection icon_c">
          <router-link to="/attention">收藏
            <span></span>
          </router-link>
        </li>
      </ul>
      <yd-cell-group title="">
        <div @click="autAccount" class="autAccountBox">
          <yd-cell-item class="cell_dec">
            ...
            <img slot="right" src="../images/visit/arrow_right.svg" type="img" class="arrow-icons">
          </yd-cell-item>
      ...
      <div class="info_list" style="margin-bottom: 0.3rem;padding-left:0.64rem">
        <div class="icon_c set_up">
          <router-link to="/settingByperson">设置
            <span></span>
          </router-link>
        </div>
      </div>
      <!--<yd-cell-group>-->
      <!--<yd-cell-item href="/settingByperson" type="link">-->
      <!--<span slot="left" class="set_up leftimg">设置</span>-->
      <!--</yd-cell-item>-->
      <!--</yd-cell-group>-->
    ...
    <!--弹窗-->
    <yd-popup v-model="showDecs" v-show="showDec" position="center" width="90%" class="phone_model">
...
<style>
  ...
  .info_item {
    ...
    background: url(../images/visit/my_application.svg) left center no-repeat, url(../images/visit/arrow_right.svg) 6.28rem center no-repeat;
  ...
  .my_clients {
    border-bottom: 0.01rem solid #e5e8ee;
    background: url(../images/visit/my_clients.svg) left center no-repeat, url(../images/visit/arrow_right.svg) 6.28rem center no-repeat;
    background-size: 0.3rem 0.4rem, 0.14rem 0.2rem;
    padding-right: 0.5rem;
  }

  .my_project {
    background: url(../images/visit/my_project.svg) left center no-repeat, url(../images/visit/arrow_right.svg) 6.28rem center no-repeat;
    background-size: 0.3rem 0.4rem, 0.14rem 0.2rem;
    padding-right: 0.5rem;
  }
  ...
  .info_photo {
    border-bottom: 0.01rem solid #e5e8ee;
    background: url(../images/visit/photo_album.svg) left center no-repeat, url(../images/visit/arrow_right.svg) 6.28rem center no-repeat;
    background-size: 0.3rem 0.4rem, 0.14rem 0.2rem;
    padding-right: 0.5rem;
  }
  ...
  .info_collection {
    border-bottom: 0.01rem solid #e5e8ee;
    background: url(../images/visit/collection.svg) left center no-repeat, url(../images/visit/arrow_right.svg) 6.28rem center no-repeat;
    background-size: 0.3rem 0.4rem, 0.14rem 0.2rem;
    padding-right: 0.5rem;
  }

  .set_up {
    background: url(../images/visit/set_up.svg) left center no-repeat, url(../images/visit/arrow_right.svg) 6.28rem center no-repeat;
    background-size: 0.3rem 0.4rem, 0.14rem 0.2rem;
    padding-right: 0.5rem;
  }
  ...
  .wl_left > div:first-child {
    width: 1rem;
    height: 1.4rem;
    background-image: url(../images/visit/my_application.svg);
  ...
  .sqzzh {
    background-image: url(../images/visit/sub_account.svg);
    background-repeat: no-repeat;
    padding-left: 0.5rem;
  }
