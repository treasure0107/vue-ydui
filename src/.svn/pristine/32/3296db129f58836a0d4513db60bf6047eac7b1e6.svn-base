...
<g>
    ...
    <div v-show="userContent">
      ...
      <div class="account_list">
        ...
        <div class="two_code" @click="codeBig"></div>
      </div>
    </div>
    ...
    methods: {
      searchName() {
        ...
        this.$http.post(searchUrl, {
          ...
          //          console.log(res.body.obj.mobile);
          //          console.log(res.body.obj.userName);
          this.userNews = res.body.obj;
//          console.log(res.body.obj.uid);
          if (this.searchContent == "") {
            this.userContent = false;
            alert("搜索的内容不能为空")
          } else if (this.userNews.mobile == undefined || this.userNews.userName == undefined) {
            alert("没有搜索到帐号")
          }
          else {
